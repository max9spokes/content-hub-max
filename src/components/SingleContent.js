...
export default function SingleContent({ data: { article } }) {
  ...
  const isFirstNodeH2 = article.body.json.content[0].nodeType === "heading-2"
  const INTRO = isFirstNodeH2
    ? article.body.json.content[0].content[0].value
    : null
  const CONTENT = article.body.json
    ...
    <section>
      <div className="container mt-2">
        ...
        <div className="row  ">
          ...
          <div className={`col col-12 ${article.mediaThumb ? "col-md-6" : 0}`}>
            <h1
              css={css`
                font-size: 32px;
                font-weight: bold;
